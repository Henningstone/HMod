...
MACRO_CONFIG_INT(SvMapDownloadSpeed, sv_map_download_speed, 2, 1, 64, CFGFLAG_SAVE|CFGFLAG_SERVER, "Number of map data packages a client gets on each request (0.7 only)")
